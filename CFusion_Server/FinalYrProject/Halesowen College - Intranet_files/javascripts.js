...
// changes location if you confirm a message for edit/deteling articles
...
function savevalue() {
var strValues = "";
var boxLength = document.addcourseform.courserelated.length;
var count = 0;
if (boxLength != 0) {
for (i = 0; i < boxLength; i++) {
if (count == 0) {
strValues = document.addcourseform.courserelated.options[i].value;
}
else {
strValues = strValues + "," + document.addcourseform.courserelated.options[i].value;
}
count++;
   }
}
document.addcourseform.courserelatedstuff.value = strValues;
}
...
function visibility(id, id1, id2) {
var el = document.getElementById(id).style; 
var el2 = document.getElementById(id1).style; 
var el3 = document.getElementById(id2).style; 
